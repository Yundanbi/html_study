const REST_API_KEY_made = "071d884bcf93ef15ab325924977ca231";

async function kyobo_made() {
  const query = "교보문고";
  ...
  try {
    const response = await fetch(url, {
      headers: {
        Authorization: `KakaoAK ${REST_API_KEY_made}`,
      },
    });
    ...
    const list = document.getElementById("kyobomade-list");
