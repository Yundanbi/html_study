const REST_API_KEY_pod = "071d884bcf93ef15ab325924977ca231";

async function podBooks() {
  const query = "바로출판";
  ...
  try {
    const response = await fetch(url, {
      headers: {
        Authorization: `KakaoAK ${REST_API_KEY_pod}`,
      },
    });
    ...
    const list = document.getElementById("kyobo_pod-list");
