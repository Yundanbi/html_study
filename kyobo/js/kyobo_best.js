const REST_API_KEY_best = "071d884bcf93ef15ab325924977ca231";

async function kyobo_best_chBooks() {
  const query = "베스트 도서";
  ...
  try {
    const response = await fetch(url, {
      headers: {
        Authorization: `KakaoAK ${REST_API_KEY_best}`,
      },
    });
    ...
    const list = document.getElementById("best_list");
